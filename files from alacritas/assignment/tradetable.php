...
<html>
    ...
    <body>
        ...
        <!--restaurant time and name-->
        <div id="headtime">
            <h2>Trade Table Cafe</h2>
            <p>Opening and Closing Times: Monday-Friday 8 am - 4pm</p>
        </div>
        <br>
        <!--item table for beverages-->
        <div id="menu">
            <table id="trade">
            <?php
                //printing out the table from db
                $table="SELECT * FROM `menu_trade`";
